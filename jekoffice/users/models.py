...
class CustomUser(AbstractUser):
    ...
    tipo_membro     = models.CharField(choices = MEMBRO_CHOICES, max_length= 10,null=True,blank = True)
    cargo           = models.CharField(choices = CARGOS_CHOICES, max_length = 70,null = True, blank = True)
